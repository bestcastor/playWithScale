...
object Anagrams {
  ...
  val dicByOccur = dictionaryByOccurrences

  /** Returns all the anagrams of a given word. */
  def wordAnagrams(word: Word): List[Word] =
    dicByOccur(wordOccurrences(word))
  ...
  //
  //    def iterSentenceAna(o: Occurrences): List[Sentence] = {
  //      if (o.isEmpty) List(List())
  //      else {
  //
  //        val coms = combinations(o)
  //        for {
  //          i <- coms if dicByOccur.keySet(i)
  //          w <- dicByOccur(i)
  //          s <- iterSentenceAna(subtract(o, i))
  //        } yield {w :: s}
  //      }
  //    }
  //
  //    val del = iterSentenceAna(occurrences)
  //    del
  //  }
